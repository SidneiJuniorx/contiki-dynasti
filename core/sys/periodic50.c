...
#ifndef PERIOD
#define PERIOD 150 // Sidnei alterou de 60 para 10
#endif
...
PROCESS(instance_process50, "Evento Esporadico 50");
...
/********************************************************************************/
void instance_50(clock_time_t event2) {

  //printf("Iniciando eventos esporádicos Instância 50 \n");

  process_start(&instance_process50, (void *)&event2);
}

/********************************************************************************/
static void send_packet50() 
{
...
/********************************************************************************/
PROCESS_THREAD(instance_process50, ev, data)
{
...
/*****************************************************************/
  ...
  while(1) {
    ...
    if(etimer_expired(&periodic)) {
      ...
      if(status == 1)
      {
        ctimer_set(&backoff_timer, SEND_TIME, send_packet50, NULL);
      }
    }

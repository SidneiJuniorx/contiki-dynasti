...
PROCESS(instance_process60, "Evento Esporadico 60");
...
/********************************************************************************/
void instance_60(clock_time_t event2) {

  //printf("Iniciando eventos esporádicos Instância 30 \n");

  process_start(&instance_process60, (void *)&event2);
}

/********************************************************************************/
static void send_packet60() 
{
...
/********************************************************************************/
PROCESS_THREAD(instance_process60, ev, data)
{
...
/*****************************************************************/
  ...
  while(1) {
    ...
    if(etimer_expired(&periodic)) {
      ...
      if(status == 1)
      {
        ctimer_set(&backoff_timer, SEND_TIME, send_packet60, NULL);
      }
    }

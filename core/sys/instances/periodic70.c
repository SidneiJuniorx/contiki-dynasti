...
PROCESS(instance_process70, "Evento Esporadico 70");
...
/********************************************************************************/
void instance_70(clock_time_t event2) {

  //printf("Iniciando eventos esporádicos Instância 70 \n");

  process_start(&instance_process70, (void *)&event2);
}

/********************************************************************************/
static void send_packet70() 
{
...
/********************************************************************************/
PROCESS_THREAD(instance_process70, ev, data)
{
...
/*****************************************************************/
  ...
  while(1) {
    ...
    if(etimer_expired(&periodic)) {
      ...
      if(status == 1)
      {
        ctimer_set(&backoff_timer, SEND_TIME, send_packet70, NULL);
      }
    }
